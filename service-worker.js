const CACHE='kbu-operasional-v9-9-6-6';
const ASSETS=['./','./index.html','./logo.png','./hologram-kbu.png','./icon-192.png','./icon-512.png','./icon-maskable-512.png','./manifest.webmanifest'];
